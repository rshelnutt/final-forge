...
### Getting Started
1. **Visit** [build.finalforge.app](https://build.finalforge.app)
2. **Select** a set to start tracking
3. **Click** cards to mark them as owned
4. **Watch** your progress update in real-time

### Saving Your Collection

**Guest Mode (Default)**
- Your collection saves automatically to your browser's local storage
- No account needed — just start tracking
- Data persists across browser sessions

**Signed In**
- Create a free account to enable cloud sync
...
- **MTG & Final Fantasy**: Trademarks of Wizards of the Coast and Square Enix respectively

---

## Links

- **Landing Site**: [finalforge.app](https://finalforge.app)
- **Collection Builder**: [build.finalforge.app](https://build.finalforge.app)
